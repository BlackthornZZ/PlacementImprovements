...
**Coming soon in v1.1.0:  Placement locking & movement (both vertically and horizontally)**
...
## Notes
**As of v1.0.0, the "Allow Sloped Placement Angles" setting is falsely marked as unimplemented.**

**As of v1.0.0, the "Allow Advanced Placement Movement" setting has been left in by accident. This currently does nothing.**
