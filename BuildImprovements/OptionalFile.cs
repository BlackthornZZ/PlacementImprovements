using System.Diagnostics.CodeAnalysis; using System.IO; using System.Reflection; using Il2CppTMPro; using MelonLoader;
using UnityEngine;
using UnityEngine.SceneManagement; using UnityEngine.UI;
using Object = System.Object;

[assembly: HarmonyDontPatchAll()] [assembly: AssemblyMetadata(Starlight.Expansion.StarlightModInfoAttributes.MinimumStarlightVersion, OptionFileInfo.MinimumStarlightVersion)]
...
class OptionFileEntrypoint : MelonMod
{
    ...
    public override void OnInitializeMelon()
    {
        ...
        if (!string.IsNullOrWhiteSpace(OptionFileInfo.MinimumGameVersion))
        {
            ...
            {
                MelonLogger.Error("The game's version too old, aborting!");
